...
import { namedSession } from './index'
...
it('should throw access error when key is undefined', async () => {
  const storage = {
    delete: jest.fn(),
    read: jest.fn(),
    write: jest.fn(),
...
it('should throw assign error when key is undefined', async () => {
  const storage = {
    delete: jest.fn(),
    read: jest.fn(),
    write: jest.fn(),
  ...
  const next = jest.fn().mockImplementation(async () => {
    expect(() => {
      ...
      new Error(
        'Cannot assign session data because the `getSessionKey` returned undefined'
      )
    )
  })
...
it('should return initial', async () => {
  const storage = {
    delete: jest.fn(),
    read: jest.fn(),
    write: jest.fn(),
...
it('should write changed value to storage', async () => {
  const storage = {
    delete: jest.fn(),
    read: jest.fn().mockReturnValue({ lol: 'kek' }),
    write: jest.fn(),
...
it('should write deeply changed value to storage', async () => {
  const storage = {
    delete: jest.fn(),
    read: jest.fn().mockReturnValue({ lol: 'kek' }),
    write: jest.fn(),
